...
namespace CKAN.Edge
{
    public class Modules
    {
        ...
        public async Task<object> Available(dynamic input)
        {
            ...
            return await Task.Run(() =>
                SharedState.Registry.CompatibleModules(SharedState.Manager.CurrentInstance.VersionCriteria())
        ...
        {
            return await Task.Run(() =>
                SharedState.Registry.IncompatibleModules(SharedState.Manager.CurrentInstance.VersionCriteria())
        ...
        private static dynamic edgeModule(CkanModule module, bool installable, bool installed, bool? upgradeable = null)
        {
            return new
            {
                ...
                Installed     = installed,
                Uninstallable = installed && !module.IsDLC,
