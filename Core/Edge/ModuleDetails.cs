...
namespace CKAN.Edge
{
    public class ModuleDetails
    {
        ...
        {
            try {
                return SharedState.Registry.AvailableByIdentifier(identifier).Select(mod => {
                    ...
                    return new
                    {
                        ...
                        GameVersionRange   = GameVersionRange.VersionSpan(SharedState.Manager.CurrentInstance.game, minKsp, maxKsp).ToString()
